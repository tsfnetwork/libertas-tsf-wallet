...
$("#mainNavBtnSettings").click(function() {
    TSFMainGUI.changeAppState("settings");
    TSFSettings.renderSettingsState();
});

TSFMainGUI = new MainGUI();
