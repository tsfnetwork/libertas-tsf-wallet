...
class Accounts {
  ...
  getKeyStoreLocation() {
    switch (os.type()) {
      case "Darwin":
        ...
        break;
      default:
        return path.join(process.env.APPDATA, "Roaming/Transaction_service_fee", "keystore");
    }
  }
  ...
  saveAccount(account) {
    fs.writeFile(path.join(EthoAccountsthis.getKeyStoreLocation(), "0x" + account.address), JSON.stringify(account), "utf8", function () {
      // file was written
    });
  }
}
